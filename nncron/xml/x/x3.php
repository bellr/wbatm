...
<body>
	...
	<form action="" method="post">
		...
		<!-- <input type="text" name="purse" value="Z418424195200" /> -->
		<select name="purse">
			<option value="Z319569093232" selected="selected">Z319569093232</option>
			<option value="R274812969994">R274812969994</option>
			<option value="E339122241969">E339122241969</option>
			<option value="U374693983066">U374693983066</option>
			<option value="C105090644359">C105090644359</option>
		</select>
		<br/>
		...
		<input type="text" name="datestart" value="20110818 00:00:00" />
		<br/>

		<label>максимальное время и дата выполнения операции:</label>
		<input type="text" name="datefinish" value="201170820 00:00:00" />
		<br/>
