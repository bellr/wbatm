...
/*
	...
	*/	
	...
	define('CER', realpath('../keys/156413310416.cer'));
	define('KEY', realpath('../keys/156413310416.key'));
	define('PASS', '156413310416key');
	echo file_get_contents(realpath('../keys/156413310416.key'));
	...
	define('PRIMARY_WMID',   '156413310416');
